export const Icon = {
  ...
  Fan: () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path fill="currentColor" stroke="none" d="M12 10.5C8 9.5 7 6.5 9 4.5C11 2 14 3 15 7C15 9.5 14 10.5 12 10.5Z"/>
      <path fill="currentColor" stroke="none" d="M12 10.5C8 9.5 7 6.5 9 4.5C11 2 14 3 15 7C15 9.5 14 10.5 12 10.5Z" transform="rotate(120 12 12)"/>
      <path fill="currentColor" stroke="none" d="M12 10.5C8 9.5 7 6.5 9 4.5C11 2 14 3 15 7C15 9.5 14 10.5 12 10.5Z" transform="rotate(240 12 12)"/>
